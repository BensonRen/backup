...
function showdispall_show10(m,dt,savename, varargin)
...
%for t=1:dfr:nframe-1
  ...
  if (~exist(fname,'file'))
    ...
    m2 = showdisp(m,t,dt1, vararg{:});
    %natom2 = showdisp(m,t,dt, 'nseg',20000, 'drmin',0.3, 'line', 'nowrap', 'colory', 'drseg');
    %natom2 = showdisp(m,t,dt, 'nseg',20000, 'drmin',0.3, 'line', 'nowrap', 'dr2',1.2 ,'colory', 'drseg');
    %natom2 = showdisp(m,t,dt, 'nseg',20000, 'drmin',0.3, 'line', 'dr2',1.2 ,'jumponly');
    %natom2 = showdisp(m,t,dt, 'nseg',200, 'drmin',0.6, 'line', 'dr2',10 ,'drmin',0.6, vararg{:});
    %natom2 = showdisp(m,t,dt, 'nseg',200, 'drmin',0.6, 'line', 'dr2',10 ,'drmin',0.6, 'dx',rand*m.rmax(1),'dy',rand*m.rmax(1), vararg{:});
    %m2 = showdisp(m,t,dt, 'nseg',200, 'drmin',0.6, 'line', 'dr2',10 ,'drmin',0.6, vararg{:});
    %m2 = showdisp(m,t,dt, 'nseg',200, 'drmin',0.6, 'line', 'dr2',10 ,'drmin',0.6, 'patch', 'patchn',10,'pub', 'w',0.1, 'colory','drpath',vararg{:});
    %m2 = showdisp(m,t,dt, 'nseg',2000, 'drmin',0.6, 'line', 'dr2',10 ,'drmin',0.6, 'patch', 'patchn',10,'pub', 'w',0.1, 'drpath', 'colordfr',dt, vararg{:});
